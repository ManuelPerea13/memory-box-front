...
# Install project dependencies con lockfile (sin --mount=cache para compatibilidad
# con el builder legacy de Docker en mark1, que no tiene BuildKit/buildx).
...
# Variables NEXT_PUBLIC_* — se hornean en el bundle del cliente en build-time.
# Se pasan con --build-arg al hacer docker build (ver scripts/deploy-mark1.sh).
