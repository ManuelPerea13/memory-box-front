...
type StockUpdateHandler = () => void;

/**
 * Recibe actualizaciones en tiempo real de stock y pedidos (página Stock).
 * Solo mantiene la conexión con la pestaña visible; backoff con límite de intentos.
 */
export default function useStockWebSocket(onStockUpdate: StockUpdateHandler) {
